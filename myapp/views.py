...
def employee_details(request):
    if request.user.is_staff:  # Check if the user is an admin
        return redirect("details")  # Redirect admins to details page
...
def details(request):
    if request.user.is_staff:
        ...
        user_specific_data = employee_data
    else:
        # Regular users see only their own data
        user_specific_data = [emp for emp in employee_data if emp["user"] == request.user.username]
